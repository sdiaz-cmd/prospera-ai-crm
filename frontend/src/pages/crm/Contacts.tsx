...
import { Plus, Search, MoreVertical, Trash2, Building2, Mail, Phone } from 'lucide-react';
...
export function Contacts() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['contacts', dSearch],
    queryFn: () => contactsService.getAll({ search: dSearch || undefined, limit: 100 }),
  });
